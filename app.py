...
======================================================
Professional Edition: Clean UI, Precise Data Extraction, 
and Deep LLM Screening using openai/gpt-oss-120b.
"""
...
CUSTOM_CSS = """
<style>
/* Professional typography and neutral corporate colors */
html, body, [class*="css"] {
...
.tm-card h4 { font-size: 1.1rem; color: #2D3748; font-weight: 600; margin-bottom: 1rem; }
...
.tm-metric-box .tm-value { font-size: 1.4rem; font-weight: 700; }
.tm-metric-box .tm-label { font-size: 0.75rem; color: #4A5568; text-transform: uppercase; letter-spacing: 0.5px;}
.tm-score-high { color: #276749; }
.tm-score-mid { color: #9C4221; }
.tm-score-low { color: #9B2C2C; }
...
def dataframe_to_formatted_excel_bytes(df: pd.DataFrame) -> bytes:
    ...
    with pd.ExcelWriter(buffer, engine="xlsxwriter") as writer:
        ...
        for col_idx, col_name in enumerate(df.columns):
            ...
            width = 20
            if col_name in ["Missing Skills (vs JD)", "Interview Questions", "Extracted Skills", "Latest Experience", "University Name"]:
                width = 40
            elif col_name in ["Match Score (%)", "CGPA"]:
                width = 15
...
with col1:
    ...
    jd_text = st.text_area("Paste JD", height=200, label_visibility="collapsed", placeholder="Paste Job Description here...")
